...
Repository hiện có **36 tests**. Unit tests không tải LLM và không gọi
...
| `test_metrics.py` | Chuẩn hóa đáp án và Exact Match |
...
| `test_experiment_serialization.py` | Config, metrics, prediction flush và trajectory flush |

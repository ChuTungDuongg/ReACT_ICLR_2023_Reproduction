...
Face provider performs real padded GPU generation. Standard and CoT batch their
single-pass prompts; CoT-SC batches every sampling round; Act and ReAct batch
active examples at each step while keeping one reusable Wikipedia environment
per batch slot.
